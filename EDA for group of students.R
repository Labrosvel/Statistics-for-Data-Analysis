...
names(h_subject) <- c('h_Econ', 'h_Man', 'h_Polit.sci', 'h_Social.sci')
h_subject
...
names(f_subject) <- c('f_Econ', 'f_Man', 'f_Polit.sci', 'f_Social.sci')
f_subject
...
names(h_siblings) <- c('h_0sibs', 'h_1sibs', 'h_2sibs', 'h_3sibs')
h_siblings
...
names(f_siblings) <- c('f_0sibs', 'f_1sibs', 'f_2sibs', 'f_3sibs') 
f_siblings
...
names(h_income) <- c('h_600-650', 'h_650-700', 'h_700-900', 'h_900-1200', 'h_1200-1450')
h_income
barplot(h_income)
...
names(f_income) <- c('f_600-650', 'f_650-700', 'f_700-900', 'f_900-1200', 'f_1200-1450')
f_income
barplot(f_income)
